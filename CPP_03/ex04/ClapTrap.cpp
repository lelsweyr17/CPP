...
ClapTrap::ClapTrap()
{
	std::cout << "sajkfhkjshdflhsdf" << std::endl;
...
ClapTrap::ClapTrap(std::string valueName)
{
	...
	std::cout << name << ITALIC BOLD << " : \"" << quotes[rand() % 8] << "\"" << RESET << std::endl;
...
ClapTrap::~ClapTrap()
{
	...
	std::cout << name << ITALIC BOLD << " : \"" << quotes[rand() % 9] << "\"" << RESET << std::endl;
...
void		ClapTrap::rangedAttack(std::string const &target)
{
	if (energyPoints - rangedAttackDamage < 0)
		...
		std::cout << name << ITALIC BOLD << " : \"" << quotes[rand() % 15] << "\"" << RESET << std::endl;
...
void		ClapTrap::meleeAttack(std::string const &target)
{
	if (energyPoints - rangedAttackDamage < 0)
		...
		std::cout << name << ITALIC BOLD << " : \"" << quotes[rand() % 12] << "\"" << RESET << std::endl;
...
void		ClapTrap::takeDamage(unsigned int amount)
{
	...
	else
	{
		...
		std::cout << name << ITALIC BOLD << " : \"" << quotes[rand() % 11] << "\"" << RESET << std::endl;
		std::cout << ITALIC "\t\t\t\t\t\t* FR4G-TP " RESET << name << ITALIC << " taking -" << amount << " HP *" << RESET << std::endl;
